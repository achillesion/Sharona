...
function MintMobile(props) {
  ...
  return (
    ...
    <Plane name='Right_Image' ref={ref} args={[1.15, 2.2]} onPointerEnter={() => Hovered()} onPointerLeave={() => UnHovered()} toneMapped={false} position={[4.1, 0, 0]} rotation={[0, -Math.PI * 0.5, 0]} scale={[2.5, 0.85, 3]} url={props.url} tranparent opacity={1}>
